...
purple = "\e[35m"
hong = "\033[1;95m"
# Đánh dấu bản quyền thương hiệu DGVIKAKA
thanh_xau = red + "[" + trang + "DGVIKAKA=.=" + red + "] " + trang + "=> "
thanh_dep = red + "[" + trang + "TOOL=.=" + red + "] " + trang + "=> "
##### Cài Thư Viện #####
...
[1;37m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[1;32m[•] TOOL TDS TIKTOK AUTO 90% CÒN 10% DÙNG AUTO CLICK VIP 👑
...
def delay(dl):
  try:
    for i in range(dl, -1, -1):
       print(f'{vang}[{trang}REVIEWTOOL247{vang}][{trang}'+str(i)+vang+']           ',end='\r')
       sleep(1)
  except:
     sleep(dl)
     print(dl,end='\r')
